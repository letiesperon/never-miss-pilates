...
ActiveAdmin.setup do |config|
  ...
  #     menu.add id: 'users', label: I18n.t('activerecord.models.user.other'), priority: 0
  #   end
  # end

  config.site_title = 'Never Miss Pilates Admin'
  config.site_title_link = ENV.fetch('FRONTEND_URL', 'www.leti.com')
  config.favicon = '/logo-square.png'
